...
$img_sql = "SELECT * FROM property_images WHERE property_id = ? ORDER BY is_main DESC";
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb mb-2">
                            <li class="breadcrumb-item"><a href="property_list.php"
                                    class="text-white opacity-75 text-decoration-none">Dashboard</a></li>
                            <li class="breadcrumb-item text-white active" aria-current="page">
                                #PROP-<?php echo str_pad($property['id'], 3, '0', STR_PAD_LEFT); ?></li>
                        </ol>
                    </nav>
                    <h1 class="display-4 fw-bold mb-3 animate-up">Refine Listing</h1>
                    <p class="lead opacity-75 animate-up" style="animation-delay: 0.1s;">Update details for
                        "<?php echo htmlspecialchars($property['title']); ?>"</p>
                </div>
            </div>
        </div>
                ...
                <div class="card-body">
                    <form method="POST" action="../controllers/update_property.php" enctype="multipart/form-data">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-7">
                                <h5 class="fw-bold border-start border-primary border-4 ps-3 mb-4">Content Refinement
                                </h5>
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-group">
                                        <span class="input-group-text bg-transparent border-end-0 rounded-start-3"><i
                            ...
                            <div class="col-md-5">
                                ...
                                <div class="mb-4">
                                    <label class="form-label">Current Availability Status <span
                                            class="text-danger">*</span></label>
                                    <div
                                        class="d-flex flex-column gap-2 bg-dark bg-opacity-25 p-3 rounded-4 shadow-sm border border-white border-opacity-10">
                                        ...
                                        <div
                                            class="form-check custom-radio border-top border-white border-opacity-10 pt-2">
                                            <input class="form-check-input" type="radio" name="status" id="statusRented"
                                                value="Rented" <?php echo $property['status'] === 'Rented' ? 'checked' : ''; ?>>
